...
n = 100-1
mu = loadtxt("output/muNPN21.txt", comments="#", dtype = float ,delimiter="\n", unpack=False)
...
ax.view_init(-160, -60)
ax.set_title(r"$W_1$", fontsize=20)
...
ax.view_init(-160, -60)
ax.set_title(r"$W_2$", fontsize=20)
ax.set_xlabel("x", fontsize=15)
ax.set_ylabel("z", fontsize=15)
ax.set_zlabel("y", fontsize=15)
ax.set_xticks([-1.0, -0.5, 0.0, 0.5, 1.0])
...
ax.view_init(-160, -60)
ax.set_title(r"$W_3$", fontsize=20)
ax.set_xlabel("x", fontsize=15)
ax.set_ylabel("z", fontsize=15)
ax.set_zlabel("y", fontsize=15)
ax.set_xticks([-1.0, -0.5, 0.0, 0.5, 1.0])
...
ax.view_init(-160, -60)
ax.set_title(r"$W_4$", fontsize=20)
ax.set_xlabel("x", fontsize=15)
ax.set_ylabel("z", fontsize=15)
ax.set_zlabel("y", fontsize=15)
ax.set_xticks([-1.0, -0.5, 0.0, 0.5, 1.0])
